...
Revision ID: d6c366fcdd68
Revises: 
Create Date: 2024-04-21 18:13:12.500403
...
def upgrade() -> None:
    ...
    sa.Column('action_type', postgresql.ENUM('HTTP_REQUEST', 'WEBHOOK', 'IF_CONDITION', name='actiontype', schema='admyral'), nullable=True),
    ...
    sa.Column('edge_type', postgresql.ENUM('TRUE', 'FALSE', 'DEFAULT', name='edgetype', schema='admyral'), nullable=True),
