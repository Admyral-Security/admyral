...
<Callout type="info">
	For more information on the API for listing pull requests, see [List pull
	requests](https://docs.github.com/en/rest/pulls/pulls?apiVersion=2022-11-28#list-pull-requests).
</Callout>
