...
14. Give your credential a name, e.g. `MS Defender`.
...
```bash
admyral secret set ms_defender_secret --value tenant_id=your_tenant_id --value client_id=your_client_id --value client_secret=your_client_secret
```
