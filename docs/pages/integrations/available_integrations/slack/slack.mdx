...
-   [List users](/integrations/available_integrations/slack/apis/list_users)
-   [Lookup user by email](/integrations/available_integrations/slack/apis/lookup_by_email)
-   [Open a conversation](/integrations/available_integrations/slack/apis/conversations_open)
-   [Add a reaction](/integrations/available_integrations/slack/apis/reactions_add)
