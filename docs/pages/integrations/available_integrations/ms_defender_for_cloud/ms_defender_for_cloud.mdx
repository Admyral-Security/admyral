...
22. In **Admyral**, go to the **Settings** page and click on **Create New Credential**. Select **Microsoft Defender for Cloud**.

23. Give your credentials a name, e.g. `MS Defender for Cloud`. Fill in the **Client ID**, **Tenant ID**, and **Client Secret**. Click on **Save Credential**.
