...
<Callout type="info">
    For Microsoft's documentation, see [Microsoft Defender Get Alert via Graph API](https://learn.microsoft.com/en-us/graph/api/security-alert-get?view=graph-rest-1.0&tabs=http).
</Callout>
...
| ----------------- | ------------------------------------------------------------------------------------------------------------------- | :------: |
| **Alert ID**      | The ID of the alert to retrieve.                                                                                    |   Yes    |
