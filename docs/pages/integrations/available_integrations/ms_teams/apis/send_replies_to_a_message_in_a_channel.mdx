...
<Callout type="info">
	For Microsoft's documentation, see [Send Replies to a Message in a Channel](https://learn.microsoft.com/en-us/graph/api/chatmessage-post-replies?view=graph-rest-1.0&tabs=http).
</Callout>
