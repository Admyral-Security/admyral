...
You can get a list of recent files associated with a specific imphash.

<Callout type="info">
	For YARAify's documentation, see [Query imphash](https://yaraify.abuse.ch/api/#imphash).
</Callout>
...
| -------- | ------------------------------------------- | :------: |
| **imphash** | The imphash to query for.       |   Yes    |
