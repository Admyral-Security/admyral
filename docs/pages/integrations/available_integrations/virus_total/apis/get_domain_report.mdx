...
<Callout type="info">
	For VirusTotal's documentation, see [Get Domain Info](https://docs.virustotal.com/reference/domain-info).
</Callout>
...
| ----------- | ------------------------------------------------------------------------------------------- | :------: |
| **Domain**  | The domain for which information will be retrieved.                                         |   Yes    |
