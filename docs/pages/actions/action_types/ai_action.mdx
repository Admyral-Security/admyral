...
There is a limit to the number of tokens that can be processed in a single prompt. This ensures efficient operation and resource usage. If your use case requires a higher token limit, please reach out on [Discord](https://discord.gg/GqbJZT9Hbf)/[Slack](https://join.slack.com/t/admyralcommunity/shared_invite/zt-2hqxj1xrr-YoWXYq7t8l3i5GyTCzEwPg), and we can discuss lifting your usage limit accordingly.
