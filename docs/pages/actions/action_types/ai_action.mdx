...
There is a limit to the number of tokens that can be processed in a single prompt. This ensures efficient operation and resource usage. If your use case requires a higher token limit, please reach out on [Discord](https://discord.gg/GqbJZT9Hbf), and we can discuss lifting your usage limit accordingly.
