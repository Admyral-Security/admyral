...
The No-Code Editor is the alternative to coding your workflows within Admyral. Every workflow is displayed in no-code as well as in code due to a bi-directional synchronization.

## Why having a no-code editor when being code-first?

-   Enable less technical users to make create workflows and make adjustments
-   Easier to communicate with non-technical stakeholders (visualization vs. code)
-   Quick to create simple automations

## Overview

The workflow builder is split up in three parts:

1. On the left panel, you can drag-and-drop new pre-built and customer actions and integrations.
...
<div align="center">
	<br />
	![No-Code Editor](../../img/no_code_editor.png)
</div>
_No-Code Editor_
...
You can always test workflows manually to ensuring they are set up properly by clicking on an action and selecting "_Run_".
