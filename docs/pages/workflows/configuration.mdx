...
3. On the right panel, you can make meta changes to the workflow such as changing the name of the workflow or adding an description. The right panel appears upon clicking on the "_Settings_" button on the top right.
...
_Make sure you have activated the workflow for it to be able to execute!_
