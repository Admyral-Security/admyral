...
-   Rust (For installation please refer to [Rust Installation](https://www.rust-lang.org/tools/install))
...
4. To run tests, execute the following inside the `backend` directory:
...
3. To run tests and format the code:
